...
const Header = ({ children, siteTitle }) => (
  <header className="usa-header usa-header--extended" role="banner">
    <div style={{backgroundColor: '#222c67', padding: '10px', width: '100%'}}>
      <img src="images/FDA_Logo_Icon_White.svg" style={{height:80, paddingTop: '10px', paddingBottom: '5px', paddingLeft: '10px'}} />
      <ul style={{listStyleType: 'none', float: 'right', marginTop: '10px'}}>
