...
const Header = ({ children, siteTitle }) => (
  <header className="usa-header usa-header--extended" role="banner">
    <div className="usa-navbar" style={{backgroundColor: '#222c67', padding: '10px', width: '100%'}}>
      <img src="images/FDA_Logo_Icon_White.svg" style={{height:80, paddingTop: '10px', paddingBottom: '10px'}} />
